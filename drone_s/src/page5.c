...
int page5()
{
	...
	bar_3d(0, 33, 120, 480, LIGHTGRAY, 0);
	
	bar_3d(0, 0, 639, 32, LIGHTGRAY, 0);
	bar_3d(1, 0, 80, 30, LIGHTGRAY, 0);
	bar_3d(81, 0, 160, 30, LIGHTGRAY, 0);
	bar_3d(161, 0, 240, 30, LIGHTGRAY, 0);
	bar_3d(241, 0, 320, 30, LIGHTGRAY, 0);
...
int editpic(int *nx, int *ny, int *nb)
{
	...
	while (1)
	{
		...
		if(edit == 1)
		{
			...
			bar(121, 440, 639, 479);
			//printf("%d", ZL);
			bar_3d(2, 300, 118, 439, DARKGRAY, 1);//scsreen
			if(pixnum>0)
			{
				for(k=0; k<pixnum; k++)
				{
